...
class BatchesControllerTest < ActionController::TestCase
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post :create, batch: { demo: @batch.demo, duration: @batch.duration, fee: @batch.fee, name: @batch.name, start_date: @batch.start_date }
    end
  ...
  test "should update batch" do
    patch :update, id: @batch, batch: { demo: @batch.demo, duration: @batch.duration, fee: @batch.fee, name: @batch.name, start_date: @batch.start_date }
    assert_redirected_to batch_path(assigns(:batch))
  end
